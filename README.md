...
This development branch targets Unreal Engine 5.7. The UE 5.5 `main` branch remains the production baseline until the 5.7 build, runtime, performance, packaging, and cross-machine validation gates pass.
