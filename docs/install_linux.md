...
Download the latest Unreal Engine 5.7 release from the [official download page](https://www.unrealengine.com/en-US/linux).
...
```bash
unzip Linux_Unreal_Engine_5.7.X.zip -d destination_folder
```
...
For more information you can read the [quick start guide](https://dev.epicgames.com/documentation/en-us/unreal-engine/linux-development-quickstart-for-unreal-engine?application_version=5.7).
