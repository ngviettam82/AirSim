...
3. Navigate to your UnrealEngine repo folder and run `Engine/Binaries/Linux/UnrealEditor` which will start Unreal Editor.
4. On first start you might not see any projects in Unreal Editor. Click on Projects tab, Browse button and then navigate to `AirSim/Unreal/Environments/Blocks/Blocks.uproject`. 
