...
```
## Usage example
Python script [detection.py](https://github.com/ngviettam82/Airsim/blob/main/PythonClient/detection/detection.py) shows how to set detection parameters and shows the result in OpenCV capture.
