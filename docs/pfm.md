...
AirSim has code to write pfm file for [C++](https://github.com/ngviettam82/Airsim/blob/main/AirLib/include/common/common_utils/Utils.hpp#L637) and read as well as write for [Python](https://github.com/ngviettam82/Airsim/tree/main/PythonClient/airsim/utils.py#L122).
