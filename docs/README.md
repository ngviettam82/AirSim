...
The [MIT License](https://github.com/ngviettam82/Airsim/blob/main/LICENSE) applies to all source files in this repository.
...
* **Precompiled UE 5.5 plugin (Win64):** [Releases](https://github.com/ngviettam82/AirSim/releases) → `AirSimPlugin-Win64.zip` (install [guide](install_precompiled.md))
* **Packaged binary (Blocks):** [Releases](https://github.com/ngviettam82/AirSim/releases) (run [guide](run_packaged.md))
* **Build from Source:** [Windows](install_windows.md) / [Linux](install_linux.md)
...
* **Docs:** in-tree (`mkdocs build` from repo root)

## Custom AirSim Capabilities & Architecture

Custom AirSim provides advanced, production-grade robotics and autonomy capabilities on Unreal Engine 5.5. See [CHANGELOG](https://github.com/ngviettam82/AirSim/blob/main/CHANGELOG.md).
...
* [PX4 ROS 2 Autonomy Architecture](px4_ros2_autonomy.md) — Production C++17 autonomy stack (`px4_ros2::ModeBase`), dynamic stopping bubbles, photogrammetry survey planner, 3D geofence, and Smart RTH battery models.
* [Web Companion Ground Control Station (GCS)](web_gcs.md) — Touch-friendly tablet & browser UI with Leaflet/Google Maps, 50 Hz WebSocket telemetry, click-to-track visual targeting, and boustrophedon survey mission generator.
* [PX4 SITL with AirSim](px4_sitl.md) & [WSL 2 Integration](px4_sitl_wsl2.md) — Complete port triad guide (TCP 4560 simulator, UDP 8888 MicroXRCEAgent, UDP 14550 QGC).
* [ROS 2 C++ Wrapper (`airsim_ros_pkgs`)](ros_cplusplus.md) — Full ROS 2 Humble bridge with direct MCAP rosbag2 recording and hardware timestamp synchronization.
* [Instance segmentation](instance_segmentation.md) / [annotation notes](annotation.md)
...
* [Native Camera Host](camera_host.md), [multirotor physics](multirotor_physics.md)
* [Legacy ROS 1 Python Wrapper](ros_python.md) (Catkin / Noetic EOL)

## Network note

RPC (`EnableRpc`, default port 41451) and CameraHost have **no authentication**. Prefer loopback or a firewalled LAN for production; see [camera_host](camera_host.md) and [settings](settings.md).
